...
import { defineComponent, ref, computed, h, createVNode, resolveDynamicComponent, unref, mergeProps, useSSRContext } from 'file:///Users/joshmasen/Developer/personal/joshua-masen-nuxt/node_modules/vue/index.mjs';
import { defu } from 'file:///Users/joshmasen/Developer/personal/joshua-masen-nuxt/node_modules/defu/dist/defu.mjs';
import { withLeadingSlash, withTrailingSlash, joinURL, encodeParam, hasProtocol, parseURL, encodePath } from 'file:///Users/joshmasen/Developer/personal/joshua-masen-nuxt/node_modules/ufo/dist/index.mjs';
import { u as useRequestEvent } from './ssr-BFzxi7jQ.mjs';
import { appendHeader } from 'file:///Users/joshmasen/Developer/personal/joshua-masen-nuxt/node_modules/h3/dist/index.mjs';
import { ssrRenderVNode } from 'file:///Users/joshmasen/Developer/personal/joshua-masen-nuxt/node_modules/vue/server-renderer/index.mjs';
...
async function _imageMeta(url) {
  {
    const imageMeta2 = await import('file:///Users/joshmasen/Developer/personal/joshua-masen-nuxt/node_modules/image-meta/dist/index.mjs').then((r) => r.imageMeta);
...
const ipxRuntime$DroExWjozE = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["ipx"]: { provider: ipxRuntime$DroExWjozE, defaults: {} }
};
const useImage = () => {
...
//# sourceMappingURL=ProseImg-0UhtWvLP.mjs.map
