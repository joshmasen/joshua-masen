import { ref, shallowRef, toRef, getCurrentInstance, onServerPrefetch, unref } from 'file:///Users/joshmasen/Developer/personal/joshua-masen-nuxt/node_modules/vue/index.mjs';
import { b as useNuxtApp, c as asyncDataDefaults, d as createError, a as useRuntimeConfig } from './server.mjs';
import { withLeadingSlash, joinURL, withoutTrailingSlash, withBase } from 'file:///Users/joshmasen/Developer/personal/joshua-masen-nuxt/node_modules/ufo/dist/index.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-B7DuiEv8.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-DBB2BQ7D.mjs.map
